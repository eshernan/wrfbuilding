...
MPI_NUM_PROCESS=2
DOMAIN_DIST=numa
HOME_EXECW=/data/bin/3.8/wrf_improve/
...
mpirun -print-rank-map -machine $HOSTS  -np $MPI_RANKS -env I_MPI_PIN_DOMAIN $DOMAIN_DIST amplxe-cl -result-dir $OUTPUT_DIR -collect advanced-hotspots -knob enable-user-tasks=true -knob analyze-openmp=true  -data-limit=2000 $HOME_EXECW/wrf.exe 
