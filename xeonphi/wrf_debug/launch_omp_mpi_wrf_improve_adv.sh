...
MPI_NUM_PROCESS=2
DOMAIN_DIST=numa
HOME_EXECW=/opt/shared/bin/3.8/wrf_debug
OUTPUT=/opt/shared/profile/sabio
HOME_DOMAIN=/opt/shared/domains/Bogota1
...
OUTPUT_DIR="improve_performance_$MPI_RANKS""_""$OMP_NUM_THREADS""_""$(date +"%H_%M_%S")"
...
mpirun -machine $HOSTS  -np $MPI_RANKS -env I_MPI_PIN_DOMAIN $DOMAIN_DIST -gtool "advixe-cl -collect survey -executable-of-interest=wrf.exe -project-dir /home/cecad/intel/advixe/projects/improve_WRF38 --search-dir src:rp=/opt/shared/WRF/3.8/debug/WRFV3:0" $HOME_EXECW/wrf.exe
